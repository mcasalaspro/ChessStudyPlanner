...
const AchievementsView = {
  ...
  render() {
    ...
    setKids(this.el,
      h('div', { class: 'row between', style: { marginBottom: '10px' } }, h('div', null, h('h1', null, icon('award', 'big'), ' Achievements'), h('p', { class: 'muted small' }, `${got} of ${list.length} unlocked`)), null),
